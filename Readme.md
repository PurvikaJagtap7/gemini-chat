...
Hey I'm Purvika Jagtap. Welcome to my project!
...
1. **Clone the repository:**
   ...
   ```sh
   git clone --depth 1 https://github.com/PurvikaJagtap7/gemini-chat.git
   ```
...
[Purvika Jagtap](https://github.com/PurvikaJagtap7/)
